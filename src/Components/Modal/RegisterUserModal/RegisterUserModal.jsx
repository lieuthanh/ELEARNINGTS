...
import { setUserId, setIsRegisterUser } from "../../../redux/modalSlice";
...
export default function RegisterUserModal() {
  ...
  useEffect(() => {
    if (userId) {
      https
        .post("/api/QuanLyNguoiDung/LayDanhSachKhoaHocChuaGhiDanh", userId, {
          headers: {
      ...
      https
        .post("/api/QuanLyNguoiDung/LayDanhSachKhoaHocChoXetDuyet", postId, {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
        })
      ...
      https
        .post("/api/QuanLyNguoiDung/LayDanhSachKhoaHocDaXetDuyet", postId, {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
        })
  ...
  let handleAccept = (courseId) => {
    const acceptInfo = { maKhoaHoc: courseId, taiKhoan: userId };
          ...
          >
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                <SiCoursera className="w-5 h-5 text-gray-500 dark:text-gray-400" />
              </div>
              <input
                type="search"
                ...
                placeholder="Tìm kiếm khóa học muốn ghi danh"
                required
                onChange={(e) => {
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {waitListToDisplay.length > 0 ? (
                  waitListToDisplay.map((course, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">{course.tenKhoaHoc}</td>
                        <td className="px-6 py-4">
                          <div className="inline-flex items-center space-x-2">
                            {/* accept */}
                            <button
                              onClick={() => handleAccept(course.maKhoaHoc)}
                              type="button"
                            ...
                            {/* cancel */}
                            <button
                              onClick={() => handleCancel(course.maKhoaHoc)}
                              type="button"
                  ...
                  <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td className="w-4 p-4 text-center" colSpan={4}>
                      Chưa có học khóa học chờ xét duyệt
                    </td>
                  </tr>
                )}
              </tbody>
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {joinListToDisplay.length > 0 ? (
                  joinListToDisplay.map((course, index) => {
